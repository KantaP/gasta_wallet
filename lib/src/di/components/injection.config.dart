...
import '../../features/authenticate/view/di/set_pin.vm.dart' as _i14;
import '../../features/authenticate/view/di/sign_in.vm.dart' as _i32;
import '../../features/dashboard/view/di/overview.vm.dart' as _i13;
...
import '../../features/introduction/service/di/splash_screen.firebase.dart'
    as _i20;
import '../../features/introduction/view/di/getting_started.vm.dart' as _i11;
import '../../features/introduction/view/di/splash_screen.vm.dart' as _i21;
import '../../features/main/view/di/main.vm.dart' as _i12;
...
import '../../features/shopping_cart/view/di/shopping_cart.vm.dart' as _i31;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.GettingStartedViewModel>(
      () => _i11.GettingStartedViewModel());
  gh.factory<_i12.MainViewModel>(() => _i12.MainViewModel());
  gh.factory<_i13.OverViewViewModel>(() => _i13.OverViewViewModel());
  gh.factory<_i14.SetPinViewModel>(() => _i14.SetPinViewModel());
  ...
  gh.factory<_i21.SplashScreenViewModel>(() =>
      _i21.SplashScreenViewModel(get<_i20.SplashScreenFirebaseService>()));
  gh.singleton<_i22.UserDataSource>(_i22.UserDataSource());
  gh.singleton<_i23.AuthenticationFirebaseService>(
      _i23.AuthenticationFirebaseService(get<_i10.FirebaseClient>()));
  ...
  gh.factory<_i31.ShoppingCartPageViewModel>(
      () => _i31.ShoppingCartPageViewModel(get<_i19.ShoppingCartService>()));
  gh.factory<_i32.SignInPageViewModel>(() => _i32.SignInPageViewModel(
      get<_i24.AuthenticationRepository>(),
      get<_i23.AuthenticationFirebaseService>()));
  return get;
}
